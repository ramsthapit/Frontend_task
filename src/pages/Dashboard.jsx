...
import { getCategories, getProducts } from '../products/productsSlice'
...
const Dashboard = () => {
  ...
  const { products, totalItems, categories, loading, error } = useSelector((state) => state.products)
...
// ]
  ...
  useEffect(() => {
    dispatch(getProducts({ page: currentPage, category: selectedCategory }))
